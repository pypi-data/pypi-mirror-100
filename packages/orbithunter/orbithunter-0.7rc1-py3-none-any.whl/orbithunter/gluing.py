        ...
        if objective == "boundary_cost":
            ...
            if current_cost < smallest_cost_so_far:
                ...
                if kwargs.get('fundamental_domain', False):
                    best_glued_orbit_so_far = best_glued_orbit_so_far.from_fundamental_domain()
                smallest_cost_so_far = current_cost
                best_glued_orbit_so_far = orbit_return_type(**vars(best_glued_orbit_so_far))
        else:
