...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.0.0-alpha.1616765663+8debf2c2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.0.0-alpha.1616765663+8debf2c2`
                """)
            else:
                raise
