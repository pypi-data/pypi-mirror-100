...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.0.0-alpha.1617304701+ac2d3e3d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.0.0-alpha.1617304701+ac2d3e3d`
                """)
            else:
                raise
