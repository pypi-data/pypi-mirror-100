...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.0.0-alpha.1617105387+b5ed1682'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.0.0-alpha.1617105387+b5ed1682`
                """)
            else:
                raise
