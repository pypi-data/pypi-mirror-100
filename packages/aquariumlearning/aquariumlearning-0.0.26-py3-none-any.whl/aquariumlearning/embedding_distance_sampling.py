...
from .util import ElementType, FrameWithEmbeddings, EmbeddingVec
...
class EmbeddingDistanceSamplingAgent(SamplingAgent):
    ...
    def load_sampling_dataset(
        self, element_type: ElementType, preprocessed_info: Dict[str, Any]
    ) -> None:
    ...
    def score_frame(self, frame: LabeledFrame) -> SamplingScoreDict:
        ...
        if self.element_type == "frame":
            ...
            if crop_embs:
                ...
                raise Exception(f"No valid embeddings were provided.")
