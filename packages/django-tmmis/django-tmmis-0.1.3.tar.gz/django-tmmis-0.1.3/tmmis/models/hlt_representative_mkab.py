...
class HltRepresentativemkab(BaseModel):
    ...
    patient_mkab = models.ForeignKey('HltMkab', models.DO_NOTHING, related_name='+', db_column='rf_PatientMKABID')
    ...
    address_org = models.ForeignKey('KlaAddress', models.DO_NOTHING, related_name='+', db_column='rf_AddressOrgID')
