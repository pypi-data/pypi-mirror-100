...
def exec_and_return(expression,scope):
    exec(f"""globals()['temp'] = {expression}""",scope)
    return globals()['temp']
...
def start_server(scope,debug = False):
            ...
            while True:
                ...
                try:
                    ...
                    try:
                        ...
                        result = exec_and_return(code,scope)
...
def do(code):
            ...
            while True:
                ...
                try:
                    ...
                    rsize = pickle.loads(s.recv(4096))
                ...
                try:
                    ...
                    result = pickle.loads(s.recv(int(rsize)))
                    return result
