...
class MigrationChain:
    ...
    def __init__(self, node):
        ...
        current_nodeid = self._node.identifier
        current_parameters = _get_parameters(self._node.base_parameter_model)

        self._init_migration_classes(current_parameters, current_nodeid)

    def _init_migration_classes(self, current_parameters, current_nodeid,
    ...
    def forward(self, macro_cmd, max_version=None):
        """
...
class OverridesMigrationChain(MigrationChain):
    ...
    def __init__(self, node, overrides_model, subflow):
        ...
        current_nodeid = self._overrides.get_nodeid()
        current_parameters = _get_parameters(overrides_model)
