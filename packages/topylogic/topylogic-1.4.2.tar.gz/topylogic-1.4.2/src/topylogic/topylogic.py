...
class graph(object):
    ...
    def set_vertex(self, id, f, glbl=None):
        r"""
        set_vertex(self, id, f, glbl=None) -> vertex
    ...
    def set_edge(self, vertex_a_id, vertex_b_id, f, glbl=None):
        r"""
        set_edge(self, vertex_a_id, vertex_b_id, f, glbl=None) -> edge
    ...
    def set_bi_edge(self, vertex_a_id, vertex_b_id, f, glbl=None):
        r"""
        set_bi_edge(self, vertex_a_id, vertex_b_id, f, glbl=None) -> PyObject *
