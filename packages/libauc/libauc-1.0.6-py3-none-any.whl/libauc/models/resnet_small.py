...
'''
# credit: https://github.com/junyuseu/pytorch-cifar-models
import torch
...
class ResNet_Cifar(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1, pred_activation='sigmoid', pretrained=False):
