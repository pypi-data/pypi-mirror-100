...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features, num_output_features):
        ...
        self.add_module('ELU', nn.ReLU(inplace=True))
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
                 num_init_features=64, bn_size=4, drop_rate=0.0, num_classes=1, memory_efficient=False, pred_activation='sigmoid'):
        ...
        self.features = nn.Sequential(OrderedDict([
            ...
            ('norm0', nn.BatchNorm2d(num_init_features, momentum=0.01)),
            ('elu0', nn.ReLU(inplace=True)),
    ...
    def forward(self, x):
        ...
        if self.pred_activation == 'l2':
            out= F.normalize(out,dim=0,p=2)
        elif self.pred_activation == 'sigmoid':
