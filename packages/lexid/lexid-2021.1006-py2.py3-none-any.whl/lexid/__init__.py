...
Since leading zeros may be stripped (e.g. by python tools following
PEP440, it may be better to start your sequence with 1001, instead of
0001.
"""
...
def next_id(prev_id):
    ...
    _maybe_next_id_str = '{0:0{1}}'.format(_maybe_next_id_val, num_digits)
