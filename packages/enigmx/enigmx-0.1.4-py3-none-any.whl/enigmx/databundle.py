...
class QuantmoonSQLManager(object):
    ...
    def __init__(self, server, database_name, driver,uid,pwd,
                 base_database='test', globalRange=False,
                 loggin="",
                 access=""):
        ...
        print(self.server,self.database_name,self.uid,self.pwd)

        self.loggin = ('Driver='+self.driver[0]+';Server='+ self.server +
                       ';Database='+self.base_database+';Uid='+self.uid[0]+';Pwd='+self.pwd[0]+';')
        print(self.loggin)
        ...
        self.access = ('Driver='+self.driver[0]+';Server='+ self.server +
                       ';Database='+self.database_name+';Uid='+self.uid[0]+';Pwd='+self.pwd[0]+';')
        print(self.access)
...
class DataRespositoryInitialization(object):
    ...
    def __init__(self, 
        ...
        print("zarrObject: ",self.zarrObject.value[0])
        ...
        if check_days: 
            ...
            self.range_dates = [self.start_date]
        print("range_dates: ",self.range_dates)     
        print("zarr dates: ",self.zarrDates)
    ...
    def geneticIterativeFunction(self, 
        ...
        print("freq y time: ", freq,time)    
        info_tuple = self.__makeTupleContent__(freq, time)
        print("info_tuple databundle.py: ",info_tuple)
