...
class EnigmX:
    ...
    def __init__(self, 
        ...
        KfeatureImportanceParams = {
            "pca_comparisson": True,
            "top_features": 10,
            "score_constraint": 0.6, "driver": "{ODBC Driver 17 for SQL Server}", "uid":"sqlserver","pwd":"J7JA4L0pwz0K56oa",
    ...
    def get_feature_importance(self, model, list_stocks, **kwargs):
        ...
        instance = featureImportance(
            model = model, 
            method = self.method, driver = self.driver, uid = self.uid, pwd = self.pwd,
