...
instance = EnigmX(bartype = 'VOLUME', 
                  method = 'MDA', 
                  base_path = '/home/heligp4/.local/lib/python3.7/site-packages/enigmx/') 
...
instance.get_feature_importance(    
                   ...
                   list_stocks = ['ACIW', 'ACN', 'ADBE', 'ADM', 'AEO', 'AES', 'AFL', 'AGCO', 'AGI', 'AGIO'], 
                   score_constraint = 0.3,server_name="34.67.233.155",database="BARS-FEATURES")
