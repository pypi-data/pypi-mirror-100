...
from clouderizer_beta.cldz_aws_lambda import lambda_deploy, lambda_delete
			...
			if type(servingproject)==dict and "id" in servingproject:
				...
				if uploadmodel_resp=="Success":
					...
					if type(servingmodel)==dict and "id" in servingmodel:
						...
						update_serving_model(servingmodel['id'],{"status":"Running","status_message":"","accessUrl":notebookAccessUrl},auth_token)
					else:
		...
		if execution_type=="model":
			...
			if type(servingproject)==dict and "id" in servingproject:		
				...
				if uploadmodel_resp=="Success":
					...
					update_serving_model(servingmodel['id'],{"status":"Running","status_message":"","accessUrl":modelAccessUrl},auth_token)
				else:
