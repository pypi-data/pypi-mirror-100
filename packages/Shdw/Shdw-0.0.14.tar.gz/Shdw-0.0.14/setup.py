...
setuptools.setup(
    ...
    version="0.0.14", # The version of your package!
    ...
    project_urls={
      'Documentation': 'https://shdw-pckg.readthedocs.io/en/latest',
      'Say Thanks!': 'https://saythanks.io/to/shivank.chhaya%40gmail.com',
      'Source': 'https://replit.com/@ShivankChhaya/shdw-pckg-actual',
    },
