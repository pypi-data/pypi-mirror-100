...
class Cob:
    ...
    def criar_cobranca_put(self, txid, body, url, cert, client_id, client_secret):
        ...
        autenticacao = get_autenticacao_token(cert, url, client_id, client_secret)
...
#             "original": "0.10"
#         },
#         "chave": 20201210000155, # parametro
#         "solicitacaoPagador": "solicitacao_pagador",
#         "infoAdicionais": [{"nome": "nome1", "valor": "valor1"}]
#     }
# if __name__ == '__main__':
#     txid = ''.join(secrets.choice(string.ascii_uppercase + string.digits) for i in range(27))
#     cob = Cob()
#     cob_put = cob.criar_cobranca_put(txid, body)
#     print('cobranca put')
#     print(cob_put[0])
#     print(cob_put[1])
#     cob_get = cob.consultar_cobranca_get(txid)
#     print('consulta get')
#     print(cob_get[0])
#     print(cob_get[1])
#     inicio='2020-12-09T08:00:00Z'
#     fim='2021-12-09T23:00:00Z'
#     cob_get = cob.consultar_lista_cobranca_get(inicio, fim)
#     print('consulta  lista get')
#     print(cob_get[0])
#     print(cob_get[1])
