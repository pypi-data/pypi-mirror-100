...
class Autenticacao:
    ...
    def autentica(self, cert, url, client_id, client_secret):
...
def get_autenticacao_token(cert, url, client_id, client_secret):
    ...
    if autenticacoes and autenticacoes[0].get_token():
        ...
        autenticacao = autenticacao_obj.autentica(cert, url, client_id, client_secret)
