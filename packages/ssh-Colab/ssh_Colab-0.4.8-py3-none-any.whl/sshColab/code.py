...
def GCSconnect(save_to_file_path=None):
    if save_to_file_path:
        print('Upload your Google Storage API token')
        files.upload()
        subprocess.call(f'chmod 600 {save_to_file_path}', shell=True)        
        os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = f'{save_to_file_path}' 
