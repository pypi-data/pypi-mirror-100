...
[boto3.AppRegistry 1.17.44](https://boto3.amazonaws.com/v1/documentation/api/1.17.44/reference/services/servicecatalog-appregistry.html#AppRegistry) service
compatible with
