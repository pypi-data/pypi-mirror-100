...
class SimBert(object):
    ...
    def __init__(self, dict_path=None, config_path=None, checkpoint_path=None, type='Tiny'):
        """
        ...
        if dict_path is None:
            p = get_module_path(f'../data/chinese_simbert_L-4_H-312_A-12_{type}.zip')
            dict_path = Path(p).parent.__str__()
            print(dict_path)

            os.system(f'cd {dict_path} && unzip {p}')
