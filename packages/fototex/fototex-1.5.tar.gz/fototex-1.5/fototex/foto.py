...
class Foto(FotoBase):
    ...
    def path(self):
        ...
        #                         f"{self.image_name}_method={self.method}"
        #                         f"_wsize={self.window_size}_dc={self.keep_dc_component}_")
        # else:
        #     return os.path.join(self.out_dir,
        #                         f"{self.image_name}_method={self.method}"
        #                         f"_wsize={self.window_size}_wstep={self.window_step}_"
    ...
    def rgb_width(self):
        if self.method == "block":
            ...
            return int(self.dataset.RasterXSize / self.window_step) + \
    ...
    def rgb_height(self):
        if self.method == "block":
            ...
            return int(self.dataset.RasterYSize / self.window_step) + \
