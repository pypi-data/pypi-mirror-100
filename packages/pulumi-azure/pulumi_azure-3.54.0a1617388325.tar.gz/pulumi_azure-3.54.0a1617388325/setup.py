...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.54.0-alpha.1617388325+85f2fcfb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.54.0-alpha.1617388325+85f2fcfb`
                """)
            else:
                raise
