...
class Database:
    ...
    def delete(self, table, id):
        sql, values = table._get_delete_sql(id)
        self.conn.execute(sql, values)
        self.conn.commit()
...
class Table:
    ...
    def _get_insert_sql(self):
        ...
        name = cls.__name__.lower()
        sql = insert_sql.format(name=name, fields=fields, placeholders=placeholders)
    ...
    def _get_select_all_sql(cls):
        ...
        name = cls.__name__.lower()
        sql = select_all_sql.format(name=name, fields=', '.join(fields))
    ...
    def _get_update_sql(self):
        ...
        sql = update_sql.format(name=name, fields=fields)

        return sql, values

    @classmethod
    def _get_delete_sql(cls, id):
        delete_sql = f"DELETE FROM {cls.__name__.lower()} WHERE id = ?"
        return delete_sql, [id]
