...
def getShapes(namePart= None, access = ['subscribed', 'public', 'owned'], bounds=None, userId= None, token = None):
...
def getMaps(namePart= None, access = ['subscribed', 'public', 'owned'], bounds = None, userId= None, bandType=None, resolutionRange=None, dateRange=None, token = None):
