...
setup(
  name = 'ChunkProcessingContinuation',         # How you named your package folder (MyLib)
  packages = ['ChunkProcessingContinuation'],   # Chose the same as "name"
  version = '0.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Continue the processing of large files processed in chunks in pandas without starting all over when stopped',   # Give a short description about your library
