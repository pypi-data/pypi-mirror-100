...
def queryCommand(command: QueryCommandsEnumeration):
...
def hMoveValveToSpecificPositionInShortestDirection(specificPosition: PositionInShortestDirection):
    cmd: str = 'h2300'
