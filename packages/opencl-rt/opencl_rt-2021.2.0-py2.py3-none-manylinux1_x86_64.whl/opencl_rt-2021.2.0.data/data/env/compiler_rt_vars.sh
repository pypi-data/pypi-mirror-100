...
if [ -z "${LD_LIBRARY_PATH}" ]; then
  export LD_LIBRARY_PATH="${CMPLR_ROOT}/${INTEL_TARGET_PLATFORM}/compiler/lib/intel64_lin"
else
  export LD_LIBRARY_PATH="${CMPLR_ROOT}/${INTEL_TARGET_PLATFORM}/compiler/lib/intel64_lin:${LD_LIBRARY_PATH}"
fi
...
if [ -f "${CMPLR_ROOT}/${INTEL_TARGET_PLATFORM}/lib/oclfpga/fpgavars.sh"  ]; then
  ...
  . "${CMPLR_ROOT}/${INTEL_TARGET_PLATFORM}/lib/oclfpga/fpgavars.sh" "$@"
fi
