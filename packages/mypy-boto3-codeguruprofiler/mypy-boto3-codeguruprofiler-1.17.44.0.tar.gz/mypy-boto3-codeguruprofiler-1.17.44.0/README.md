...
[boto3.CodeGuruProfiler 1.17.44](https://boto3.amazonaws.com/v1/documentation/api/1.17.44/reference/services/codeguruprofiler.html#CodeGuruProfiler) service
compatible with
