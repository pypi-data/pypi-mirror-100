...
class PubSubFactory:
    ...
    def create_subscription_if_doesnt_exist(self, subscriber_name, topic_name) -> pubsub_v1.types.pubsub_gapic_types.Subscription:
        subscription_path = self.get_subscription_path(subscriber_name, topic_name)
        ...
        try:
            ...
            if ex.grpc_status_code == grpc.StatusCode.NOT_FOUND:
                return self.subscriber.api.create_subscription(name=subscription_path, topic=self.get_topic_path(topic_name),
