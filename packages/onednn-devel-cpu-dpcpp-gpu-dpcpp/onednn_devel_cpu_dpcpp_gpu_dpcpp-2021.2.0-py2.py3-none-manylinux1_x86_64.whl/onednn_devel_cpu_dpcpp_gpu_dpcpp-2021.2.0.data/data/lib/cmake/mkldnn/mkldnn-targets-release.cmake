...
set_target_properties(MKLDNN::mkldnn PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "sycl;OpenCL;-lpthread;TBB::tbb;dl"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdnnl.so.2.2"
  IMPORTED_SONAME_RELEASE "libdnnl.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS MKLDNN::mkldnn )
list(APPEND _IMPORT_CHECK_FILES_FOR_MKLDNN::mkldnn "${_IMPORT_PREFIX}/lib/libdnnl.so.2.2" )
