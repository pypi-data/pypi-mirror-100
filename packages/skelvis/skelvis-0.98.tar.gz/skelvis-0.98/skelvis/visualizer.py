...
class SkeletonVisualizer:
    ...
    def __get_skeletons(self, positions: List[Positions],
        ...
        return [skeleton for skeleton in map(
                lambda position_color_tuple: Skeleton(
    ...
    def __display_video_player(self, fps, frames):
        ...
        frame_slider = widgets.IntSlider(value=0, min=0, max=frames.shape[1] - 1, step=1, description='Frame')
