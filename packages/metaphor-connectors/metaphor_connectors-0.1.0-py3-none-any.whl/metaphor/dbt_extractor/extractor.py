...
class DbtExtractor(BaseExtractor):
    ...
    async def extract(self, config: DbtRunConfig) -> List[Dataset]:
        ...
        if not platform:
            logger.error("Invalid platform from manifest.json")
    ...
    def _parse_manifest(self) -> str or None:
