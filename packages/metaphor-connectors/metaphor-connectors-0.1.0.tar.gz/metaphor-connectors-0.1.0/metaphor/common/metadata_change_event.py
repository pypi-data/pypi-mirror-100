...
class DatasetLogicalID:
    """Similar to the concept of URN from https://github.com/linkedin/datahub that identify an
    entity logically, besides
    the system generated UUID. It's a must have for any entity that will be ingested. Since
    the source won't know the
    UUID, has to be logical ID.
    """
...
class MetadataChangeEvent:
    ...
    def from_dict(obj: Any) -> 'MetadataChangeEvent':
        ...
        return MetadataChangeEvent(dataset, event_header, person, tenant)
