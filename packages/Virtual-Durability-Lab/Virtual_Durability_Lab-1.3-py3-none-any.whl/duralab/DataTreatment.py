...
class DataTreatment:
    """
        ...
        ----------
        ValueError
            Parameter 'test_result' is missing or incorrect. Please enter a TestSample instance, for further information go to help(TestSample).
    ...
    def __init__(self, **kwargs):
        ...
        try:
            if not self.test and not isinstance(self.test, TestSample):
            ...
            if not self.test and not TestSample.__name__ in str(type(self.test)):
                raise ValueError("Parameter 'test_result' is missing or incorrect. Please enter a Test instance, for further information go to help(Test).")
    ...
    def mle(self):
        ...
        if components_number < 20 and self.test.data_type == "Low Right Censored Data":
            print("The number of test result is too low, the result may not represent reality.")
