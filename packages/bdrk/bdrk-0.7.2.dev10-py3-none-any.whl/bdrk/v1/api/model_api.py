...
class ModelApi(object):
    ...
    def create_model_version(self, model_id, **kwargs):  # noqa: E501
        ...
        :param CreateModelVersionSchema create_model_version_schema:
    ...
    def create_model_version_with_http_info(self, model_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ModelVersionSchema, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['model_id', 'project_id', 'create_model_version_schema']  # noqa: E501
        ...
        body_params = None
        if 'create_model_version_schema' in local_var_params:
            body_params = local_var_params['create_model_version_schema']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            '/v1/bdrk/model/{model_id}/version/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='ModelVersionSchema',  # noqa: E501
    ...
    def get_artefact_download_url(self, model_id, artefact_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: ModelVersionDownloadUrlSchema
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_artefact_download_url_with_http_info(self, model_id, artefact_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ModelVersionDownloadUrlSchema, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ModelVersionDownloadUrlSchema',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
