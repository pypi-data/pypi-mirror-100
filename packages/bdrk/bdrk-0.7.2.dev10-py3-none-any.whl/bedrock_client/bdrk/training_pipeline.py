...
def log_params(params: Mapping[str, str]):
    ...
    Args:
        params (Mapping[str, str]): new params to be logged.
...
def download_model(model_id: str, version: str, path: str = ""):
    ...
    bdrk.bedrock_client.download_and_unzip_model_version(
        model_id=model_id, version=version, path=path
    )
