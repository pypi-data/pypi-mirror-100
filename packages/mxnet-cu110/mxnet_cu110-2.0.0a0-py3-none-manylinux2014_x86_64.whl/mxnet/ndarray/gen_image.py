...
def crop(data=None, x=_Null, y=_Null, width=_Null, height=_Null, out=None, name=None, **kwargs):
    ...
    Defined in ../src/operator/image/crop.cc:L50
...
def random_crop(data=None, xrange=_Null, yrange=_Null, width=_Null, height=_Null, interp=_Null, out=None, name=None, **kwargs):
    ...
    Defined in ../src/operator/image/crop.cc:L78
...
def random_lighting(data=None, alpha_std=_Null, out=None, name=None, **kwargs):
    ...
    Defined in ../src/operator/image/image_random.cc:L270
...
def random_resized_crop(data=None, xrange=_Null, yrange=_Null, width=_Null, height=_Null, interp=_Null, out=None, name=None, **kwargs):
    ...
    Defined in ../src/operator/image/crop.cc:L113
...
def resize(data=None, size=_Null, keep_ratio=_Null, interp=_Null, out=None, name=None, **kwargs):
    ...
    Defined in ../src/operator/image/resize.cc:L74
