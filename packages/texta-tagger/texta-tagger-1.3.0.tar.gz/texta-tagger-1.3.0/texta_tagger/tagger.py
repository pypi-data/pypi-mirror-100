...
class Tagger:
    ...
    def __init__(self, workers=1, description="Tagger", embedding=None, mlp=None, custom_stop_words=[], ignore_numbers=False, ignore_punctuation=True,
                 test_size=0.2, classifier=CLASSIFIERS[0], vectorizer=VECTORIZERS[0], max_examples_per_class=10000):
        ...
        # set text processor
        self.text_processor = self._create_text_processor(embedding, mlp, custom_stop_words, ignore_numbers, ignore_punctuation)
    ...
    def _create_text_processor(self, embedding, mlp, custom_stop_words, ignore_numbers, ignore_punctuation):
        """
        ...
        text_processor = TextProcessor(phraser=phraser, lemmatizer=mlp, custom_stop_words=custom_stop_words, ignore_numbers=ignore_numbers, ignore_punctuation=ignore_punctuation)
