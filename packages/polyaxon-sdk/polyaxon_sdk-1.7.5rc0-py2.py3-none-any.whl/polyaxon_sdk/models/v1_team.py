...
"""
    ...
    The version of the OpenAPI document: 1.7.5-rc0
...
class V1Team(object):
    ...
    def __init__(self, uuid=None, name=None, projects=None, hubs=None, registries=None, settings=None, created_at=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
