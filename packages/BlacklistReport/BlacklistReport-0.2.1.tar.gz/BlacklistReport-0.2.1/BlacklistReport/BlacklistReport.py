...
def generate_blacklist_report(gc_host: Dict, hours: int, opswat_key: str, gc_customer_name: str):
...
class BlacklistReport:
    ...
    def fetch_incidents(self, hours: int = 24) -> List[Dict]:
