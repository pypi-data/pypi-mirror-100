...
class ThingsStatusApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __list_spaces_collections_items(
            self,
            space,
            collection_name,
            **kwargs
            ...
            >>> thread = api.list_spaces_collections_items(space, collection_name, async_req=True)
            >>> result = thread.get()
        ...
        self.list_spaces_collections_items = _Endpoint(
            settings={
                ...
                'operation_id': 'list_spaces_collections_items',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__list_spaces_collections_items
        )

        def __show_spaces_collections_item(
            self,
            space,
            collection_name,
            thing_id,
            **kwargs
            ...
            >>> thread = api.show_spaces_collections_item(space, collection_name, thing_id, async_req=True)
            >>> result = thread.get()
        ...
        self.show_spaces_collections_item = _Endpoint(
            settings={
                ...
                'operation_id': 'show_spaces_collections_item',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__show_spaces_collections_item
        )
