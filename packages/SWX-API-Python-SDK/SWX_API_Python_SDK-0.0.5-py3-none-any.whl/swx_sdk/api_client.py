...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ClustersApi()
        api_instance.create_spaces_cluster  # this is an instance of the class Endpoint
        api_instance.create_spaces_cluster()  # this invokes api_instance.create_spaces_cluster.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_spaces_cluster.callable or self.callable in this class
