...
class OpenTracingMiddleware(MiddlewareMixin):
    ...
    def _init_tracing(self):
        ...
        elif getattr(settings, "OPENTRACING_TRACER_CALLABLE", None) is not None:
        ...
        # configure to add trace response headers
        tracing._trace_response_header_enabled = getattr(
            settings, "SIGNALFX_TRACE_RESPONSE_HEADER_ENABLED", True
        )
