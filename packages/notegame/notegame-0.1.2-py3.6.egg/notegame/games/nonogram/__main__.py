...
from .animation import CursesRenderer, StringsPager
from .core.backtracking import Solver
from .core.board import make_board
from .core.common import BOX
from .core.renderer import BaseAsciiRenderer
from .reader import NonogramsOrg, Pbn, PbnLocal, example_file, read_example
from .utils.other import ignored
...
def _setup_logs(
    ...
    try:
        ...
        format_ = '%(color)s' + format_.replace('%(lineno)d',
                                                '%(lineno)d%(end_color)s')
    except ImportError:
