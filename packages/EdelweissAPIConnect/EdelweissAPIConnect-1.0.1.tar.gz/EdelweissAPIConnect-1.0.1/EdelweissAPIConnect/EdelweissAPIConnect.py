...
The positions taken in MIS, will be sqaured off on the same day by the client or till the exchange squared off.
    ...
    def PlaceMF(self, Token, ISIN_Code, Transaction_Type, Client_Code, Quantity, Amount,
        ...
        data = {'currentOrdSts': '', 'token': Token, 'isin': ISIN_Code, 'txnTyp': Transaction_Type,
                ...
                'reqstdBy': self.__constants.get_AccId(), 'folioNo': Folio_Number,
    ...
    class __Config:
        ...
        def __init__(self):
            ...
            # self.EquityContractURL = "http://emtuat.edelweiss.in/app/toccontracts/instruments.zip"
            # self.MFContractURL = "https://emtuat.edelweiss.in/app/toccontracts/mfInstruments.zip"
...
class Feed:
    ...
    def __init__(self, symbols, accid, userid, callBack, subscribe_order: bool = True, subscribe_quote: bool = True):
        ...
        self.__appID = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcHAiOjAsImZmIjoiVyIsImJkIjoid2ViLXBjIiwibmJmIjoxNjE2Mzk3MzMyLCJzcmMiOiJlbXRtdyIsImF2IjoiMS4wLjAiLCJhcHBpZCI6ImQ5MDM1NjFiZTFhYWUyYWY3M2RjZTJjOWJhODFiODViIiwiaXNzIjoiZW10IiwiZXhwIjoxNjE2NDM3ODAwLCJpYXQiOjE2MTYzOTc2MzJ9.iy2c_iialRdLSTLcHMHD0JM81DDUMHwGx9SrreVass8"

        # New code TCP
        # sock = socket.create_connection(["mstreamuat.edelweiss.in", 12009], 10000)
        sock = socket.create_connection(["tocstream.edelweiss.in", 9443], 10000)
