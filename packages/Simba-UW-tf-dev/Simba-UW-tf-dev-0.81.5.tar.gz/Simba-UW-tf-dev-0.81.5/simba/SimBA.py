...
class loadprojectini:
    ...
    def pupMenu(self):
        ...
        dist_start = Entry_Box(lbl_pup, 'Start distance criterion', '20')
        ...
        dam_name.entry_set('mother')
        pup_name = Entry_Box(lbl_pup, 'Pup Name', '20')
        pup_name.entry_set('pup')
        ...
        dig_classifier_name.grid(row=13, sticky=W)
