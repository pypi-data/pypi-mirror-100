...
class Migration(migrations.Migration):
    ...
    def dump_data_with_logo_update(apps, schema_editor):
        ...
        for setting in settings:
            ...
            SETTINGS["image_pk"] = setting.logo.pk
        settings.delete()
    ...
    def load_data_with_logo_update(apps, schema_editor):
        ...
        if SETTINGS:
            image = Image.objects.get(pk=SETTINGS["image_pk"])
            site = Site.objects.first()
            SiteSettings.objects.create(logo_type=SETTINGS["logo_type"], image=image, site=site)
