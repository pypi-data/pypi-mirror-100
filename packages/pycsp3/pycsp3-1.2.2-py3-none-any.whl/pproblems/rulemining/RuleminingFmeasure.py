...
#command: python3 pproblems/rulemining/RuleminingFmeasure.py -dataparser=pproblems/rulemining/RuleminingParser.py pproblems/rulemining/instances/ecoli1d/ecoli1d.1.desc pproblems/rulemining/instances/ecoli1d/ecoli1d.individuals.1.training pproblems/rulemining/instances/ecoli1d/ecoli1d.individuals.1.test 1 1 None None 161303570206733226776123046875_83450 0
...
attributes, prediction, individuals, nb_rules, nb_terms, solution_data, solution_type, id_file, borne_min = data
...
satisfy(
    ...
    fmeasure_3 == 2 * fmeasure_2, fmea == fmeasure_3 // fmeasure_1
)
...
name = construct_filename("model_"+str(max_rules)+"_"+str(max_terms_per_rule)+"_")
print("Xml file name:", name)
print()
instance = compile(name)

ace = AceProcess()
# to change the executable
ace.set_command("java -Xmx50000M -jar ace/build/libs/ACE-20-12.jar")
# to extend the logger file name of the solver
ace.extend_logger(id_file)
# to add options in the form of string 
#ace.add_string_options("-positive=str2 -valh=Rand")
#ace.add_string_options("-aie=3 -vie=100000000 -positive=str2 -valh=Rand -npc")
ace.add_string_options("-positive=str2 -npc -jsonLimit=0")
if solution_data != "None" and solution_type == "Warm":
    ace.add_string_options("-warm="+str(solution_data))
    
# solving
result, solution = ace.solve(instance)
