import os
from genesis.app.services import files_service, svn_service
from genesis.app.config import SVN_PARENT_PATH, SVN_PARENT_URL, PROJECTS_FOLDER, TEMPLATE_FILES_DIR
