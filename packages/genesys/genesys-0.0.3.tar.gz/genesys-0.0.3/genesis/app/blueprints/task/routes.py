...
from genesis.app.config import (SVN_PARENT_PATH,
                                SVN_PARENT_URL,
                                PROJECTS_FOLDER,
                                FILE_MAP,
                                LOGIN_NAME)
from genesis.app.blueprints.task.utils import create_task_file, create_new_task_acl, delete_task_file
from genesis.app.services import svn_service, project_service
...
class Task(Resource):
    ...
    def create_task_file(self, project_name, base_file_directory, base_svn_directory, all_persons, task_type):
        ...
        # svn_commit_message = f'genesis added and commit {base_file_directory}'
