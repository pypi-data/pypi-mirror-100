...
from genesis.app.config import SVN_PARENT_PATH, SVN_PARENT_URL, PROJECTS_FOLDER, FILE_MAP
from genesis.app.blueprints.project.utils import create_project_folders, create_project_file_map
from genesis.app.services import svn_service, project_service, files_service
import os
import shutil
from genesis.app.utils import config_helpers
from genesis.app.blueprints.asset.utils import rename_asset_task_file, rename_task_acl_section
...
class Asset(Resource):
    ...
    def rename_asset(self, data, project_name):
        for asset_task in data:
            ...
            # replacing file tree mount point with genesis config mount point
