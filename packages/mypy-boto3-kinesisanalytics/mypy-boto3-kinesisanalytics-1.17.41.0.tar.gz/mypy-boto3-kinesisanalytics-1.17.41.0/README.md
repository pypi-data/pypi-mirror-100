...
[boto3.KinesisAnalytics 1.17.41](https://boto3.amazonaws.com/v1/documentation/api/1.17.41/reference/services/kinesisanalytics.html#KinesisAnalytics) service
compatible with
