...
[boto3.CodeStarconnections 1.17.40](https://boto3.amazonaws.com/v1/documentation/api/1.17.40/reference/services/codestar-connections.html#CodeStarconnections) service
compatible with
