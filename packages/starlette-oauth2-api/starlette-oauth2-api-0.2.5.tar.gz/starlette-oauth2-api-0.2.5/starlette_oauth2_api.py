...
class AuthenticateMiddleware:
    ...
    """
    def __init__(self, app: ASGIApp, providers, public_paths=None, get_keys=None, key_refresh_minutes=None) -> None:
        self._app = app
        ...
        if key_refresh_minutes is None:
            ...
            self._timeout = {provider: datetime.timedelta(minutes=key_refresh_minutes[provider]) for provider in providers}
        else:
