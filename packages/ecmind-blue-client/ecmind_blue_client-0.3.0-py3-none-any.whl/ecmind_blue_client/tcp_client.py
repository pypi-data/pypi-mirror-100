...
class TcpClient(Client):
    ...
    def __init__(self, hostname:str, port:int, appname:str, username:str, password:str, use_ssl:Optional[bool]=True, file_cache_byte_limit:Optional[int]=33554432, auto_reconnect:bool=True):
