...
class CInitNet:
    ...
    def readInputData(self):
        ...
        for field in required_fields_node:
        ...
        link_type_name_flag = True if 'link_type_name' in link_data.columns else False
        ...
        for i in range(len(link_data)):
            ...
            if link_type_name_flag: link.link_type_name = link_data.loc[i,'link_type_name']
