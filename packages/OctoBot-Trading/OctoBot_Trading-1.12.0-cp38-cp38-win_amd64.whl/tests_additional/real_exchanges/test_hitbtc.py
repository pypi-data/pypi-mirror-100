...
class TestHitBtcRealExchangeTester(RealExchangeTester):
    ...
    async def test_get_market_status(self):
        ...
        assert market_status[Ecmsc.PRECISION.value][Ecmsc.PRECISION_AMOUNT.value] >= 1e-05  # to be fixed in hitbtc tentacle
        assert market_status[Ecmsc.PRECISION.value][Ecmsc.PRECISION_PRICE.value] >= 1e-05  # to be fixed in hitbtc tentacle
