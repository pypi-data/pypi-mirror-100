...
async def test_adapt_price():
    ...
    assert adapt_price(symbol_market, 0.00015) == 0.0001
    assert adapt_price(symbol_market, 0.005) == 0.005
    assert adapt_price(symbol_market, 1) == 1

    assert adapt_price(symbol_market, 56.5128597145) == 56.5128
    assert adapt_price(symbol_market, 1251.0000014576121234854513) == 1251.0000
    ...
    assert adapt_price(symbol_market, 56.5128597145) == 56.51285971
    assert adapt_price(symbol_market, 1251.0000014576121234854513) == 1251.00000145
...
async def test_check_and_adapt_order_details_if_necessary():
    ...
    quantity = 0.5
    price = 2
    assert check_and_adapt_order_details_if_necessary(quantity, price, symbol_market) == [(quantity, price)]
    ...
    quantity = 1
    price = 100
    assert check_and_adapt_order_details_if_necessary(quantity, price, invalid_cost_symbol_market) == []
    ...
    quantity = 10
    price = 49
    assert check_and_adapt_order_details_if_necessary(quantity, price, symbol_market) == [(1.83673469, 49),
                                                                                               (4.08163265, 49),
                                                                                               (4.08163265, 49)]
    ...
    quantity = 10
    price = 50
    assert check_and_adapt_order_details_if_necessary(quantity, price, symbol_market) == [(2, 50), (4, 50),
                                                                                               (4, 50)]
    ...
    quantity = 200
    price = 5
    assert check_and_adapt_order_details_if_necessary(quantity, price, symbol_market) == [(40.0, 5), (40.0, 5),
                                                                                               (40.0, 5), (40.0, 5),
                                                                                               (40.0, 5)]
    ...
    quantity = 10
    price = 49
    assert check_and_adapt_order_details_if_necessary(quantity, price, symbol_market_without_max) == [(10, 49)]

    # high quantity but no max quantity => no split
    quantity = 10000000
    price = 49
    assert check_and_adapt_order_details_if_necessary(quantity, price, symbol_market_without_max) == \
           [(10000000, 49)]

    # high price but no max price => no split
    quantity = 10
    price = 4900000
    assert check_and_adapt_order_details_if_necessary(quantity, price, symbol_market_without_max) == [(10, 4900000)]
...
async def test_split_orders():
    ...
    valid_quantity = 5
    price = 20
    assert split_orders(total_price, max_cost, valid_quantity,
...
async def test_adapt_quantity():
    ...
    assert adapt_quantity(symbol_market, 0.0001) == 0.0001
    assert adapt_quantity(symbol_market, 0.00015) == 0.0001
    assert adapt_quantity(symbol_market, 0.005) == 0.005
    assert adapt_quantity(symbol_market, 1) == 1.0000000000000000000000001
    assert adapt_quantity(symbol_market, 1) == 1

    assert adapt_quantity(symbol_market, 56.5128597145) == 56.5128
    assert adapt_quantity(symbol_market, 1251.0000014576121234854513) == 1251.0000

    # will use default (0)
    symbol_market = {Ecmsc.PRECISION.value: {}}
    assert adapt_quantity(symbol_market, 0.0001) == 0
    assert adapt_quantity(symbol_market, 0.00015) == 0
    assert adapt_quantity(symbol_market, 0.005) == 0
    assert adapt_quantity(symbol_market, 1) == 1.0000000000000000000000001
    assert adapt_quantity(symbol_market, 1) == 1

    assert adapt_quantity(symbol_market, 56.5128597145) == 56
    assert adapt_quantity(symbol_market, 1251.0000014576121234854513) == 1251
    
    
async def test_trunc_with_n_decimal_digits():
    assert trunc_with_n_decimal_digits(1.00000000001, 10) == 1
    assert trunc_with_n_decimal_digits(1.00000000001, 11) == 1.00000000001
