...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', '4.0.0-alpha.1617369516+e5934493'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random 4.0.0-alpha.1617369516+e5934493`
                """)
            else:
                raise
