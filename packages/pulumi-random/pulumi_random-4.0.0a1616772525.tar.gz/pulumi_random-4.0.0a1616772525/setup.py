...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', '4.0.0-alpha.1616772525+19f5c3de'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random 4.0.0-alpha.1616772525+19f5c3de`
                """)
            else:
                raise
