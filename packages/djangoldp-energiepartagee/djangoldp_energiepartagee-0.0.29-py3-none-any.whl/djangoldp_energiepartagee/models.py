...
class Contribution(Model):
    ...
    class Meta(Model.Meta):
        ...
        serializer_fields = ['actor', 'year', 'amount', 'contributionnumber', 'paymentto', 'paymentmethod', 'calldate', 'paymentdate', 'receptdate', 
            'receivedby', 'contributionstatus', 'receptnumber', 'receptfile', 'callfile', 'ventilationpercent', 'ventilationto', 'ventilationdate', 
            'factureventilation', 'amountincents'
        ]
