...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, content_guard=None, pulp_labels=None, repository_version=None, name=None, base_path=None, repository=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
