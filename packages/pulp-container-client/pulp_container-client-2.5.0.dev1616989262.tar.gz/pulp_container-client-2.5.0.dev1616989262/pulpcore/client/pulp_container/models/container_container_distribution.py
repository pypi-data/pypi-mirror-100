...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, content_guard=None, pulp_labels=None, repository=None, base_path=None, name=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
