...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, repository=None, repository_version=None, pulp_created=None, pulp_href=None, content_guard=None, name=None, base_path=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
