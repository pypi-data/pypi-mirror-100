...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, repository=None, base_path=None, name=None, pulp_labels=None, content_guard=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
