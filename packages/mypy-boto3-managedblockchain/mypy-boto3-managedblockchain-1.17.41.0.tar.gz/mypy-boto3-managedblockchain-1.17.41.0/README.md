...
[boto3.ManagedBlockchain 1.17.41](https://boto3.amazonaws.com/v1/documentation/api/1.17.41/reference/services/managedblockchain.html#ManagedBlockchain) service
compatible with
