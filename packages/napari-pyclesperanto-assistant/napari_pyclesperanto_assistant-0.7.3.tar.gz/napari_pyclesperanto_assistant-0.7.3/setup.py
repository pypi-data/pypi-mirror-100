...
setuptools.setup(
    ...
    install_requires=["numpy", "pyopencl", "toolz", "scikit-image", "napari==0.4.5", "napari_plugin_engine", "pyclesperanto_prototype==0.7.3", "magicgui==0.2.5", "numpy!=1.19.4", "pyperclip"],
    python_requires='>=3.6',
    classifiers=[
