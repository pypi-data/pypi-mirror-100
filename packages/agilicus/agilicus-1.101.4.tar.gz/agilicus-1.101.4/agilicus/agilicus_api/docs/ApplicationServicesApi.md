...
> ListApplicationServicesResponse list_application_services(org_id=org_id, updated_since=updated_since, protocol_type=protocol_type)
...
protocol_type = 'protocol_type_example' # str | ApplicationService protocol type (optional)
    ...
    try:
        # Get a subset of the ApplicationServices
        api_response = api_instance.list_application_services(org_id=org_id, updated_since=updated_since, protocol_type=protocol_type)
        pprint(api_response)
    except ApiException as e:
