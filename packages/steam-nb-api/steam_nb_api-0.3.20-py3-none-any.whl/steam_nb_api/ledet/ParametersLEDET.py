...
class ParametersLEDET:
    ...
    def setPersistentCurrents(self, dIdt, timeStep):
        # LUT controlling power supply, Current [A]. Two cycles of ramping from 0 to nominal current and back to zero
        self.Inputs.I_PC_LUT = [0, 0, self.Inputs.I00, self.Inputs.I00, 0, 0, self.Inputs.I00, self.Inputs.I00, 0, 0]
        self.Inputs.I00 = 0
        ...
        self.Inputs.tQuench = t_PC_LUT[-2]
