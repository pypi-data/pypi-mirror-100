...
static const yytype_int16 yyrline[] =
{
     ...
     224,   230,   236,   243,   249,   259,   263,   268,   274,   278,
     282,   288,   292,   297,   303,   309,   313,   318,   322,   329,
...
#line 1554 "./src/getdate.c"
    break;

  case 6:
#line 210 "./src/getdate.y"
               {
	    yyHaveZone++;
	}
#line 1562 "./src/getdate.c"
    break;

  case 7:
#line 213 "./src/getdate.y"
               {
	    yyHaveDate++;
	}
#line 1570 "./src/getdate.c"
    break;

  case 8:
#line 216 "./src/getdate.y"
              {
	    yyHaveDay++;
	}
#line 1578 "./src/getdate.c"
    break;

  case 9:
#line 219 "./src/getdate.y"
              {
	    yyHaveRel++;
	}
#line 1586 "./src/getdate.c"
    break;

  case 10:
#line 224 "./src/getdate.y"
                             {
...
#line 1597 "./src/getdate.c"
    break;

  case 11:
#line 230 "./src/getdate.y"
                                        {
...
#line 1608 "./src/getdate.c"
    break;

  case 12:
#line 236 "./src/getdate.y"
                                         {
	    yyHour = (yyvsp[-3].Number);
	    yyMinutes = (yyvsp[-1].Number);
	    yyMeridian = MER24;
...
#line 1620 "./src/getdate.c"
    break;

  case 13:
#line 243 "./src/getdate.y"
                                                     {
...
#line 1631 "./src/getdate.c"
    break;

  case 14:
#line 249 "./src/getdate.y"
                                                      {
	    yyHour = (yyvsp[-5].Number);
	    yyMinutes = (yyvsp[-3].Number);
	    yySeconds = (yyvsp[-1].Number);
...
#line 1644 "./src/getdate.c"
    break;

  case 15:
#line 259 "./src/getdate.y"
                {
	    yyTimezone = (yyvsp[0].Number);
	    yyDSTmode = DSToff;
	}
#line 1653 "./src/getdate.c"
    break;

  case 16:
#line 263 "./src/getdate.y"
                   {
	    yyTimezone = (yyvsp[0].Number);
	    yyDSTmode = DSTon;
	}
#line 1662 "./src/getdate.c"
    break;
...
#line 1680 "./src/getdate.c"
    break;

  case 19:
#line 278 "./src/getdate.y"
                   {
	    yyDayOrdinal = 1;
	    yyDayNumber = (yyvsp[-1].Number);
	}
#line 1689 "./src/getdate.c"
    break;

  case 20:
#line 282 "./src/getdate.y"
                        {
	    yyDayOrdinal = (yyvsp[-1].Number);
	    yyDayNumber = (yyvsp[0].Number);
	}
#line 1698 "./src/getdate.c"
    break;

  case 21:
#line 288 "./src/getdate.y"
                                {
	    yyMonth = (yyvsp[-2].Number);
	    yyDay = (yyvsp[0].Number);
	}
#line 1707 "./src/getdate.c"
    break;
...
#line 1717 "./src/getdate.c"
    break;

  case 23:
#line 297 "./src/getdate.y"
                                     {
...
#line 1728 "./src/getdate.c"
    break;

  case 24:
#line 303 "./src/getdate.y"
                                   {
	    /* e.g. 17-JUN-1992.  */
	    yyDay = (yyvsp[-2].Number);
	    yyMonth = (yyvsp[-1].Number);
...
#line 1739 "./src/getdate.c"
    break;

  case 25:
#line 309 "./src/getdate.y"
                          {
	    yyMonth = (yyvsp[-1].Number);
	    yyDay = (yyvsp[0].Number);
	}
#line 1748 "./src/getdate.c"
    break;
...
#line 1758 "./src/getdate.c"
    break;

  case 27:
#line 318 "./src/getdate.y"
                          {
	    yyMonth = (yyvsp[0].Number);
	    yyDay = (yyvsp[-1].Number);
	}
#line 1767 "./src/getdate.c"
    break;

  case 28:
#line 322 "./src/getdate.y"
                                   {
	    yyMonth = (yyvsp[-1].Number);
	    yyDay = (yyvsp[-2].Number);
	    yyYear = (yyvsp[0].Number);
	}
#line 1777 "./src/getdate.c"
    break;

  case 29:
#line 329 "./src/getdate.y"
                       {
	    yyRelSeconds = -yyRelSeconds;
	    yyRelMonth = -yyRelMonth;
	}
#line 1786 "./src/getdate.c"
    break;

  case 31:
#line 336 "./src/getdate.y"
                                {
	    yyRelSeconds += (yyvsp[-1].Number) * (yyvsp[0].Number) * 60L;
	}
#line 1794 "./src/getdate.c"
    break;

  case 32:
#line 339 "./src/getdate.y"
                                {
	    yyRelSeconds += (yyvsp[-1].Number) * (yyvsp[0].Number) * 60L;
	}
#line 1802 "./src/getdate.c"
    break;

  case 33:
#line 342 "./src/getdate.y"
                       {
	    yyRelSeconds += (yyvsp[0].Number) * 60L;
	}
#line 1810 "./src/getdate.c"
    break;

  case 34:
#line 345 "./src/getdate.y"
                             {
	    yyRelSeconds += (yyvsp[-1].Number);
	}
#line 1818 "./src/getdate.c"
    break;

  case 35:
#line 348 "./src/getdate.y"
                             {
	    yyRelSeconds += (yyvsp[-1].Number);
	}
#line 1826 "./src/getdate.c"
    break;

  case 36:
#line 351 "./src/getdate.y"
                    {
	    yyRelSeconds++;
	}
#line 1834 "./src/getdate.c"
    break;

  case 37:
#line 354 "./src/getdate.y"
                               {
	    yyRelMonth += (yyvsp[-1].Number) * (yyvsp[0].Number);
	}
#line 1842 "./src/getdate.c"
    break;

  case 38:
#line 357 "./src/getdate.y"
                               {
	    yyRelMonth += (yyvsp[-1].Number) * (yyvsp[0].Number);
	}
#line 1850 "./src/getdate.c"
    break;

  case 39:
#line 360 "./src/getdate.y"
                      {
	    yyRelMonth += (yyvsp[0].Number);
	}
#line 1858 "./src/getdate.c"
    break;

  case 40:
#line 365 "./src/getdate.y"
                     {
	    (yyval.Meridian) = MER24;
	}
#line 1866 "./src/getdate.c"
    break;

  case 41:
#line 368 "./src/getdate.y"
                    {
	    (yyval.Meridian) = (yyvsp[0].Meridian);
	}
#line 1874 "./src/getdate.c"
    break;


#line 1878 "./src/getdate.c"
