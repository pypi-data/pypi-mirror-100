...
from ..svgelements import (SVG_ATTR_VECTOR_EFFECT, SVG_VALUE_NON_SCALING_STROKE,
                         Angle, Arc, Circle, Color, Ellipse, Group, Matrix,
                         Move, Path, Polygon, Polyline, SimpleLine, SVGImage,
                         SVGText, Viewbox)
