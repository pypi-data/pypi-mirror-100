...
class MWindow(wx.Frame, Module):
    """
    Silence window class does some of the more fancy operations for the windows. This includes saving and
    ...
    MWindows have a hook finalize and initialize into window_open and window_close to register and unregister
