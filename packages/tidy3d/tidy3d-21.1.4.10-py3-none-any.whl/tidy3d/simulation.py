    ...
    def compute_modes(self, mode_object, Nmodes):
        ...
        if isinstance(mode_object, ModeMonitor):
            try:
                ...
                mnt_data.mode_plane._set_eps(self, mnt_data.freqs)
            ...
            try:
                ...
                freq = mode_object.source_time.frequency
                yee = True
                if (isinstance(mode_object, PlaneWave) or 
                        isinstance(mode_object, PlaneSource)):
                    yee = False
                src_data.mode_plane._set_eps(self, freq, yee=yee)
