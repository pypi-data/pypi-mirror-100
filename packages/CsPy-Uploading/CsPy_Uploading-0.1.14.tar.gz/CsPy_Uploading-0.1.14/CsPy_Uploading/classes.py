...
class DownloadJob:
    ...
    WORK IN PROGRESS
    """
    def __init__(self, query, save_file_path, file_name=None, bq_project_read=None,
                 bq_key=None, bq_key_path=None, dsn=None,
            ...
            try:
                ...
                if self.download_setting.vm_status:
                    ...
                    if self.bq_key is not None:
                        ...
                        if self.bq_key_path is not None:
                            directory_name = str(self.bq_key_path).replace("\\", "/")
...
class UploadJob:
    ...
    def __init__(self, bq_project, bq_dataset, table_name,
                 bq_key=None, bq_key_path=None, csv=None, columns=None, query=None, dsn=None, save_file_path=None, schema=None, date_column=None,
