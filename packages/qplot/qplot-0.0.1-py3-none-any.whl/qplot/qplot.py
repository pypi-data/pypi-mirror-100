...
def quickplot(
    ...
    Cursor              boolean, if true you can get details on mouseclick [default: True]
    Cursor_Line         boolean, if true you can get details in Window on mouseclick [default: False]
