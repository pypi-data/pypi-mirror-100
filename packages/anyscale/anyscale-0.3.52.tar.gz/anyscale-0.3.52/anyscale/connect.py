...
the current working directory. The project files are hashed to fingerprint it.
...
active sessions, or the session files hash (generated when the session was created) is different from the local project
hash, a session is created / updated using "anyscale up". A new session is 'created' when all other sessions are in-use, otherwise an existing one is updated. Note that we perform
this check while holding the session lock (below) to avoid race conditions.
However note that the "anyscale up" part is not under the lock (this is a TODO).
...
# NOTE: If these are modified, `frontend/cli/tests/test_anyscale.py::test_pinned_images` must be run
# to verify that the new images use the right python version, CUDA files & ray commit!
PINNED_IMAGES = {
    "anyscale/ray-ml:nightly-py36-cpu": "anyscale/ray-ml@sha256:40672a4c2299b413756fc59b507cfa99c1c81fe4ee3169a0186965e27626fd57",
    "anyscale/ray-ml:nightly-py36-gpu": "anyscale/ray-ml@sha256:bc2d05657745fc5e181c027c0f9cf895ed9816c6e8ec6048c03815f19ddedc2a",
    "anyscale/ray-ml:nightly-py37-cpu": "anyscale/ray-ml@sha256:20b94d65cb5bb2556b1500c0132de0cf93abe00e243981b0b77bc23d3bec2020",
    "anyscale/ray-ml:nightly-py37-gpu": "anyscale/ray-ml@sha256:91a3538ebef30871174c8b61bd3d59e3670ed53bb63dee95a26e0114ecd59006",
    "anyscale/ray-ml:nightly-py38-cpu": "anyscale/ray-ml@sha256:dfcc8d64f50b2369c2936b586a1939af5bea0bd628a9b58c8aaefd1cf9e78a5a",
    "anyscale/ray-ml:nightly-py38-gpu": "anyscale/ray-ml@sha256:8d3cb7cdaf92decd6d689ef8d99a8dbaaa5cb77541d6e26b78e873825d44fc1e",
    "anyscale/ray:nightly-py36-cpu": "anyscale/ray@sha256:881379afb2265fd9108b1df0a164d9f672e991f334a4d50d9d9633fa75c9467b",
    "anyscale/ray:nightly-py36-gpu": "anyscale/ray@sha256:143848e1ad541377a7d9420ea48c36dd0bd67f692a2d82d9fdd4f9fcd77a2af1",
    "anyscale/ray:nightly-py37-cpu": "anyscale/ray@sha256:548226df14db5ae6501be89e2ac70eae82403e9ebee1db605c43ecfff97a29e2",
    "anyscale/ray:nightly-py37-gpu": "anyscale/ray@sha256:be108bea66cd961c3c9b95daff4fc65298532a6dbeff2847d0e8dd3fde52e7f3",
    "anyscale/ray:nightly-py38-cpu": "anyscale/ray@sha256:44b2369acf86a6c7a2a4718eea048e752090fb79142123bd4b617e3f44130d07",
    "anyscale/ray:nightly-py38-gpu": "anyscale/ray@sha256:635f1e0debfd31e4d397baf840bd6c4ad1b5ad5db1912467a03fd7224cb65126",
}
