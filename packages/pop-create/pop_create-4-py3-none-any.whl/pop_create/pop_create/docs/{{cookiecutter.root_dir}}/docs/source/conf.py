...
copyright = "{{cookiecutter.this_year}}, {{cookiecutter.author}}"
author = "{{cookiecutter.author}}"

# Strip version info from ../../{{cookiecutter.clean_name}}/version.py
with open(Path(Path(__file__).parent.parent.parent, '{{cookiecutter.clean_name}}', 'version.py')) as version_file:
