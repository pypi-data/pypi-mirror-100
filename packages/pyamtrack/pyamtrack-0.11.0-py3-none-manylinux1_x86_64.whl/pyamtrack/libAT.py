...
def AT_KatzModel_inactivation_cross_section_m2(p_E_MeV_u, p_particle_no, p_rdd_model, p_rdd_parameters, p_er_model, p_gamma_parameters, p_stop_power_source, p_inactivation_cross_section_m2):
	"""
	Wrapping function generated for C language function documented as follows:
	TODO
	@param[in] n
...
def AT_KatzModel_KatzExtTarget_ButtsKatz_TrackWidth(p_z2kappabeta2, p_m):
	"""
	Wrapping function generated for C language function documented as follows:
	TODO
	...
	@return track width
	"""
	p_z2kappabeta2__internal = p_z2kappabeta2
	p_m__internal = p_m
	ret = _libAT.lib.AT_KatzModel_KatzExtTarget_ButtsKatz_TrackWidth(p_z2kappabeta2__internal.encode() if type(p_z2kappabeta2__internal) is str else p_z2kappabeta2__internal
			,p_m__internal.encode() if type(p_m__internal) is str else p_m__internal
			)
	return ret
	

def AT_KatzModel_KatzExtTarget_Zhang_TrackWidth(p_z2kappabeta2, p_m):
	"""
	Wrapping function generated for C language function documented as follows:
	TODO
	@param[in] z2kappabeta2  TODO
	...
	p_z2kappabeta2__internal = p_z2kappabeta2
	p_m__internal = p_m
	ret = _libAT.lib.AT_KatzModel_KatzExtTarget_Zhang_TrackWidth(p_z2kappabeta2__internal.encode() if type(p_z2kappabeta2__internal) is str else p_z2kappabeta2__internal
			,p_m__internal.encode() if type(p_m__internal) is str else p_m__internal
			)
	return ret
	

def AT_KatzModel_single_field_survival_from_sigma(p_dose_Gy, p_E_MeV_u, p_particle_no, p_sigma_m2, p_D0_Gy, p_m, p_sigma0_m2, p_stopping_power_source_no):
	"""
	Wrapping function generated for C language function documented as follows:
	TODO
	@param[in] dose_Gy
	...
	p_E_MeV_u__internal = p_E_MeV_u
	p_particle_no__internal = p_particle_no
	p_sigma_m2__internal = p_sigma_m2
	p_D0_Gy__internal = p_D0_Gy
	p_m__internal = p_m
	p_sigma0_m2__internal = p_sigma0_m2
	p_stopping_power_source_no__internal = p_stopping_power_source_no
	ret = _libAT.lib.AT_KatzModel_single_field_survival_from_sigma(p_dose_Gy__internal.encode() if type(p_dose_Gy__internal) is str else p_dose_Gy__internal
			,p_E_MeV_u__internal.encode() if type(p_E_MeV_u__internal) is str else p_E_MeV_u__internal
			,p_particle_no__internal.encode() if type(p_particle_no__internal) is str else p_particle_no__internal
			,p_sigma_m2__internal.encode() if type(p_sigma_m2__internal) is str else p_sigma_m2__internal
...
def AT_KatzModel_inactivation_cross_section_approximation_m2(p_E_MeV_u, p_particle_no, p_rdd_model, p_er_model, p_m_number_of_targets, p_sigma0_m2, p_kappa):
	"""
	Wrapping function generated for C language function documented as follows:
	TODO
	@param[in] E_MeV_u                   TODO
...
def AT_KatzModel_single_field_survival(p_dose_Gy, p_E_MeV_u, p_particle_no, p_rdd_model, p_rdd_parameters, p_er_model, p_D0_Gy, p_m, p_sigma0_m2, p_use_approximation, p_kappa, p_stopping_power_source_no):
	"""
	Wrapping function generated for C language function documented as follows:
	TODO
	...
	p_kappa__internal = p_kappa
	p_stopping_power_source_no__internal = p_stopping_power_source_no
	ret = _libAT.lib.AT_KatzModel_single_field_survival(p_dose_Gy__internal.encode() if type(p_dose_Gy__internal) is str else p_dose_Gy__internal
			,p_E_MeV_u__internal.encode() if type(p_E_MeV_u__internal) is str else p_E_MeV_u__internal
			,p_particle_no__internal.encode() if type(p_particle_no__internal) is str else p_particle_no__internal
			,p_rdd_model__internal.encode() if type(p_rdd_model__internal) is str else p_rdd_model__internal
			,p_rdd_parameters__internal.encode() if type(p_rdd_parameters__internal) is str else p_rdd_parameters__internal
...
def AT_KatzModel_single_field_survival_optimized_for_fluence_vector(p_dose_Gy, p_E_MeV_u, p_particle_no, p_rdd_model, p_rdd_parameters, p_er_model, p_D0_Gy, p_m, p_sigma0_m2, p_use_approximation, p_kappa, p_stopping_power_source_no, p_survival):
	"""
	Wrapping function generated for C language function documented as follows:
	TODO
	...
	"""
	# Procedure to check if an IN array is empty:
	for in_array_argument in [p_dose_Gy,p_rdd_parameters]:
		if not in_array_argument:
			warnings.warn("You passed an empty list as an IN parameter.")
	...
	# Array sizes variables initialization:
	p_number_of_items = len(p_dose_Gy)
	p_number_of_items__internal = p_number_of_items
	p_dose_Gy__internal = p_dose_Gy
	p_E_MeV_u__internal = p_E_MeV_u
	p_particle_no__internal = p_particle_no
...
def AT_KatzModel_sigma_um2_single(p_E_MeV_u, p_particle_no, p_a0_um, p_m, p_D0_Gy, p_katz_model_flavour, p_stop_power_source):
	"""
	Wrapping function generated for C language function documented as follows:
...
def AT_KatzModel_sigma_um2(p_E_MeV_u, p_particle_no, p_a0_um, p_m, p_D0_Gy, p_katz_model_flavour, p_stop_power_source, p_sigma_um2):
	"""
	Wrapping function generated for C language function documented as follows:
	Calculates inactivation cross-section (sigma) for given energy.
