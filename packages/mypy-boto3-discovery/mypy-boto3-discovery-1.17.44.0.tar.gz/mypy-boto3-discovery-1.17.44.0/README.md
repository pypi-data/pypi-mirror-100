...
[boto3.ApplicationDiscoveryService 1.17.44](https://boto3.amazonaws.com/v1/documentation/api/1.17.44/reference/services/discovery.html#ApplicationDiscoveryService) service
compatible with
