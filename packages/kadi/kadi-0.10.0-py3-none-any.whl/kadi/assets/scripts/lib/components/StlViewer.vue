...
<template>
  <div class="card bg-light p-1" ref="container">
    ...
    <div v-else>
      <div class="toolbar mr-1">
        <button title="Toggle wireframe" type="button" class="btn btn-link text-muted" @click="toggleWireframe">
...
export default {
  ...
  methods: {
    ...
    onLoad(geometry) {
      ...
      // Somehow calculate a good default distance along the z-axis for the camera relative to the size of the rendered
      // object.
  ...
  mounted() {
    if (!WEBGL.isWebGLAvailable()) {
      this.error = 'WebGL not available.';
      return;
    }
