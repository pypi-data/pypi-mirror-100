...
def test_shipment_remaining_days():
    ...
    timelines = shipments_timelines(sh_df, tasks_df=tasks_df)
    result_should_be = pd.DataFrame(
        data={
            "shipment_id": ["1", "2", "3"],
            "workflow_id": ["1", "2", "3"],
...
def test_shipments_timelines_with_transit_time():
    ...
    result = shipments_timelines(active_shipments_data_df=sh_df, tasks_df=tasks_df)
    pd.testing.assert_frame_equal(result, result_should_be)
...
def test_estimated_remaining_daily_workload():
    ...
    timelines = shipments_timelines(sh_df, tasks_df)
    print(timelines)
    result_should_be = pd.DataFrame(
        data={
            "shipment_id": ["1", "2"],
            ...
            "delivery_date": [None, None],
            "arrival_date": [None, None],
            "workload_estimation_start_date": [date.today(), date(2020, 12, 26)],
            "remaining_days": [0, 11],
...
def test_shipments_daily_workload_timelines():
    ...
    shipment_2_workload = [13.0, 1.0, 6.0, 16.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0]
...
def test_shipments_daily_workload_timelines_with_tracking_dates():
    ...
    dates_sh_1 = pd.date_range(start=date(2020, 11, 15), end=date(2020, 11, 24))
