...
global_install_prefix='/tmp/pip-req-build-i1fhs0z0/_skbuild/linux-x86_64-3.7/cmake-install'
global_git_summ='v1.1.1'
global_git_hash='86a5163'
global_git_date='2019-11-09 22:42:29 +0800'
global_git_branch='HEAD'
global_tf_include_dir='/opt/_internal/cpython-3.7.9/lib/python3.7/site-packages/tensorflow/include'
global_tf_libs=''
