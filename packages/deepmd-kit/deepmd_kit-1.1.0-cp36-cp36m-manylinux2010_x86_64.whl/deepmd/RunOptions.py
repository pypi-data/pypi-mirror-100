...
global_install_prefix='/tmp/pip-req-build-5t5raw3y/_skbuild/linux-x86_64-3.6/cmake-install'
global_git_summ='v1.1.0'
global_git_hash='d735223'
global_git_date='2019-11-04 18:43:46 +0800'
global_git_branch='HEAD'
global_tf_include_dir='/opt/_internal/cpython-3.6.12/lib/python3.6/site-packages/tensorflow/include'
global_tf_libs=''
