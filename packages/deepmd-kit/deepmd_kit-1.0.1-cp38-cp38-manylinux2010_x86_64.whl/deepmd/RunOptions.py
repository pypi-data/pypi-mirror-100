...
global_install_prefix='/tmp/pip-req-build-s5dxxheu/_skbuild/linux-x86_64-3.8/cmake-install'
global_git_summ='v1.0.1'
global_git_hash='982a991'
global_git_date='2019-10-11 18:50:00 +0800'
global_git_branch='HEAD'
global_tf_include_dir='/opt/_internal/cpython-3.8.7/lib/python3.8/site-packages/tensorflow/include'
global_tf_libs=''
