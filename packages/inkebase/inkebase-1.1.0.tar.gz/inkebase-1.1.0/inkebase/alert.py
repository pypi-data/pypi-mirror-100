...
def falcon(metric, step, value, type, tag):
    '''
    推送方式：falcon
    '''
    lo_host = socket.gethostname()
    payload = []
    ts = int(time.time())
...
if __name__ == '__main__':
	dingding("d7ff220ea352833923b5ea2cbe44b503945bdd62549bc0b56cff48c066e4a0b1","监控:我是刘西瓜")
	falcon("mjk",60,100,"GAUGE","cluster=mjk,tag=heiheihei")
