...
The `pwgen` command:
```bash
usage: pwgen [-h] [--input INPUT] [--url URL] [--input-file-type {auto,openapi,jsonschema,json,yaml,dict,csv}] [--output OUTPUT]
...
[https://github.com/pyworksasia/fastapi-code-generator](https://github.com/pyworksasia/fastapi-code-generator)

### pydantic-pycharm-plugin
[A JetBrains PyCharm plugin](https://plugins.jetbrains.com/plugin/12861-pydantic) for [`pydantic`](https://github.com/samuelcolvin/pydantic).

[https://github.com/pyworksasia/pydantic-pycharm-plugin](https://github.com/pyworksasia/pydantic-pycharm-plugin)
...
[https://github.com/pyworksasia/pyworks-generator](https://github.com/pyworksasia/pyworks-generator)

## License

pyworks-generator is released under the MIT License. http://www.opensource.org/licenses/mit-license
