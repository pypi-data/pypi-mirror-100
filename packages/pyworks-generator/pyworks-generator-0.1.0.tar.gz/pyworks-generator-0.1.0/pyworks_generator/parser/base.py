...
from pyworks_generator import Protocol, runtime_checkable
from pyworks_generator.format import CodeFormatter, PythonVersion
from pyworks_generator.imports import IMPORT_ANNOTATIONS, Import, Imports
from pyworks_generator.model import pydantic as pydantic_model
from pyworks_generator.model.base import ALL_MODEL, DataModel, DataModelFieldBase
from pyworks_generator.model.enum import Enum
from pyworks_generator.parser import DefaultPutDict, LiteralType
from pyworks_generator.reference import ModelResolver, Reference
from pyworks_generator.types import DataType, DataTypeManager, StrictTypes
...
class Parser(ABC):
    ...
    def _get_text_from_url(self, url: str) -> str:
        from pyworks_generator.http import get_body
