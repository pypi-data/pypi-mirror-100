...
from pyworks_generator.format import PythonVersion, is_supported_in_black
from pyworks_generator.parser import LiteralType
from pyworks_generator.reference import is_url
...
def main(args: Optional[Sequence[str]] = None) -> Exit:
    ...
    if namespace.version:  # pragma: no cover
        from pyworks_generator.version import version
