...
from pyworks_generator.model.pydantic import dump_resolve_reference_action
from pyworks_generator.parser import DefaultPutDict, LiteralType
from pyworks_generator.parser.base import Parser
from pyworks_generator.types import StrictTypes
...
def generate(
    ...
    *,
    ...
    if input_file_type == InputFileType.OpenAPI:
        from pyworks_generator.parser.openapi import OpenAPIParser

        parser_class: Type[Parser] = OpenAPIParser
    else:
        from pyworks_generator.parser.jsonschema import JsonSchemaParser
