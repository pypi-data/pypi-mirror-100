...
class IcingaCollector(object):
    ...
    def collect_services(self):
        ...
        request_url = "https://{0}:5665/v1/objects/services".format(self.ms_source)
        data = {
        ...
        response = requests.post(
            ...
            auth=(settings.ICINGA_API_USER, settings.ICINGA_API_PASS),
            verify=False,
    ...
    def collect_alerts(self):
        ...
        request_url = "https://{0}:5665/v1/objects/hosts".format(self.ms_source)
        data = {
            "attrs": ["last_state"],
