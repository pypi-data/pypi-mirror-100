...
def calculate_validation_score(client, model, classification, datapoints, maxbatch):
    ...
    count = count_number_of_unvalidated_datapoints(client, classification['classname'])
    ...
    for batch in range(1, batchcount + 1):
        ...
        _score_query_result(client, classification, index, result, classification['classname'], properties, score)
