...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', '4.6.0-alpha.1617113757+28d6f587'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform 4.6.0-alpha.1617113757+28d6f587`
                """)
