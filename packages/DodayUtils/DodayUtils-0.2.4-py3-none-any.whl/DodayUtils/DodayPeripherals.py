...
class D2250_sticker:
	...
	def send_to_d2250(self, tmp_folder_path, job_name, printer_name=""):
		...
		conn.printFile(sticker_printer_name,tmp_folder_path+"/output_sticker.pdf",job_name,{})
...
class EPSON_invoice:
	...
	def print_order_invoice(self, order_info, printer_name="ARGOX_D2-250_PPLB", **kwargs):
		...
		if int(order_info["plastic_bag"]) > 0:
			...
			self.append_order_item(sf, len(order_info.orders)+1, order_info.get_plastic_bag_str(), 1, order_info["plastic_bag"])
