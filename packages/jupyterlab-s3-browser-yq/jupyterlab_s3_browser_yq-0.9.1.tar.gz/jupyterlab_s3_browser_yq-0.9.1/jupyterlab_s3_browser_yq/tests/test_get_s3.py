...
import jupyterlab_s3_browser_yq
...
def test_get_single_bucket():
    ...
    result = jupyterlab_s3_browser_yq.get_s3_objects_from_path(s3, "/")
...
def test_get_files_inside_bucket():
    ...
    result = jupyterlab_s3_browser_yq.get_s3_objects_from_path(s3, "/test")
    expected_result = [
        {
            "name": "test1.txt",
            "path": "test/test1.txt",
