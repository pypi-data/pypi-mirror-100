    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_cloudfront_authorization._jsii": [
            "cdk-cloudfront-authorization@1.32.0.jsii.tgz"
        ],
        "cloudcomponents.cdk_cloudfront_authorization": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-certificatemanager>=1.95.1, <2.0.0",
        "aws-cdk.aws-cloudfront-origins>=1.95.1, <2.0.0",
        "aws-cdk.aws-cloudfront>=1.95.1, <2.0.0",
        "aws-cdk.aws-cognito>=1.95.1, <2.0.0",
        "aws-cdk.aws-iam>=1.95.1, <2.0.0",
        "aws-cdk.aws-lambda>=1.95.1, <2.0.0",
        "aws-cdk.aws-s3>=1.95.1, <2.0.0",
        "aws-cdk.core>=1.95.1, <2.0.0",
        "aws-cdk.custom-resources>=1.95.1, <2.0.0",
        "cloudcomponents.cdk-lambda-at-edge-pattern>=1.31.0, <2.0.0",
