...
def users(ctx, **kwargs):
    ...
    execute(
        ...
        query(
          $offset: Int!
          $limit: Int!
          $sort: users_order_by = { updated_at: desc }
...
def problems(ctx, **kwargs):
    ...
    execute(
        ...
        query(
          $offset: Int!
          $limit: Int!
          $sort: problems_order_by = { updated_at: desc }
...
def indicators(ctx, **kwargs):
    ...
    execute(
        ...
        query(
          $offset: Int!
          $limit: Int!
          $sort: indicators_order_by = { updated_at: desc }
...
def competitions(ctx, **kwargs):
    ...
    execute(
        ...
        query(
          $offset: Int!
          $limit: Int!
          $sort: competitions_order_by = { updated_at: desc }
...
def progress(ctx, **kwargs):
    ...
    execute(
        ...
        query(
          $offset: Int!
          $limit: Int!
          $sort: progress_order_by = { updated_at: desc }
...
def environments(ctx, **kwargs):
    ...
    execute(
        ...
        query(
          $offset: Int!
          $limit: Int!
          $sort: environments_order_by = { updated_at: desc }
...
def matches(ctx, **kwargs):
    ...
    execute(
        ...
        query(
          $offset: Int!
          $limit: Int!
          $sort: matches_order_by = { updated_at: desc }
...
def solutions(ctx, **kwargs):
    ...
    execute(
        ...
        query(
          $offset: Int!
          $limit: Int!
          $sort: solutions_order_by = { updated_at: desc }
