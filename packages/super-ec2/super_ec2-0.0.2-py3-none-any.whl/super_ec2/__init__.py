'''
[![NPM version](https://badge.fury.io/js/super-ec2.svg)](https://badge.fury.io/js/super-ec2)
...
@jsii.enum(jsii_type="super-ec2.AmiOSType")
...
@jsii.interface(jsii_type="super-ec2.ISuperEC2BaseProps")
...
class _ISuperEC2BasePropsProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "super-ec2.ISuperEC2BaseProps"
...
class SuperEC2Base(
    ...
    jsii_type="super-ec2.SuperEC2Base",
):
    '''
    :stability: experimental
    '''
...
@jsii.interface(jsii_type="super-ec2.IJenkinsEC2Props")
...
class _IJenkinsEC2PropsProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "super-ec2.IJenkinsEC2Props"
    pass
...
class JenkinsEC2(
    ...
    jsii_type="super-ec2.JenkinsEC2",
):
    '''
    :stability: experimental
    '''
