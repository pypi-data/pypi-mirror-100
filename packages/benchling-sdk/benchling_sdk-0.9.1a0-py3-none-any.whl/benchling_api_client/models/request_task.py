...
from ..models.request_task_schema_property import RequestTaskSchemaProperty
...
class RequestTask:
    ...
    schema: RequestTaskSchemaProperty
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        schema = RequestTaskSchemaProperty.from_dict(d.pop("schema"))
