...
from ..models.request_schema_archive_record import RequestSchemaArchiveRecord
...
class RequestSchema:
    ...
    archive_record: Union[Unset, None, RequestSchemaArchiveRecord] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _archive_record is not None and not isinstance(_archive_record, Unset):
            archive_record = RequestSchemaArchiveRecord.from_dict(_archive_record)
