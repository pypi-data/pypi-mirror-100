...
from ..models.assay_run_schema_property import AssayRunSchemaProperty
...
class AssayRun:
    ...
    fields: Fields
    id: str
    schema: Optional[AssayRunSchemaProperty]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _schema is not None:
            schema = AssayRunSchemaProperty.from_dict(_schema)
