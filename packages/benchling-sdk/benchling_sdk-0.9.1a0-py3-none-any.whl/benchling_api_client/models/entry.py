...
from ..models.entry_schema_property import EntrySchemaProperty
...
class Entry:
    ...
    schema: Union[Unset, None, EntrySchemaProperty] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _schema is not None and not isinstance(_schema, Unset):
            schema = EntrySchemaProperty.from_dict(_schema)
