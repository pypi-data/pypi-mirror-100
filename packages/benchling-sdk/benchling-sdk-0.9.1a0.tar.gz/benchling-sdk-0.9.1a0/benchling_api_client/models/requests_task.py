...
from ..models.requests_task_schema_property import RequestsTaskSchemaProperty
...
class RequestsTask:
    ...
    id: str
    schema: Union[Unset, None, RequestsTaskSchemaProperty] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _schema is not None and not isinstance(_schema, Unset):
            schema = RequestsTaskSchemaProperty.from_dict(_schema)
