...
from ..models.assay_result_schema_property import AssayResultSchemaProperty
...
class AssayResult:
    ...
    fields: Fields
    id: str
    schema: AssayResultSchemaProperty
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        schema = AssayResultSchemaProperty.from_dict(d.pop("schema"))
