...
from ..models.plate_schema_property import PlateSchemaProperty
...
class Plate:
    ...
    schema: Union[Unset, None, PlateSchemaProperty] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _schema is not None and not isinstance(_schema, Unset):
            schema = PlateSchemaProperty.from_dict(_schema)
