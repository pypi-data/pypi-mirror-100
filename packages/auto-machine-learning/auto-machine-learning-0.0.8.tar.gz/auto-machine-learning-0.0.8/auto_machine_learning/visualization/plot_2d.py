...
def bar_2d(stats, Y, X, groups,file_name='index.html',download_png=None,height=1500,width=1500):
...
def bar_2dsubplot(stats, Y, plots,file_name='index.html',download_png=None,height=1500, width=1500):
