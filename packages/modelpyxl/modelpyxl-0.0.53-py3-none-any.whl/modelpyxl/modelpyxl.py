...
class Style:
    ...
    def __init__(self, name, row, column, data_type, font, alignment, fill, border):
        ...
        self.__font = copy.copy(font)
        self.__alignment = copy.copy(alignment)
        self.__fill = copy.copy(fill)
        self.__border = copy.copy(border)
...
class Model:
    ...
    def upload(self,worksheet):
        ...
        for style in self.styles:
            #worksheet[style.name].data_type = copy.copy(style.data_type)
            worksheet[style.name].font = copy.copy(style.font)
            worksheet[style.name].fill = copy.copy(style.fill)
            worksheet[style.name].border = copy.copy(style.border)
            worksheet[style.name].alignment = copy.copy(style.alignment)
