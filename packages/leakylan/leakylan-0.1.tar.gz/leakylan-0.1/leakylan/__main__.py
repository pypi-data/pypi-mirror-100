...
def recieve():
    ...
    if os.path.exists("cgi-bin"):
        os.chdir("leakylan")
        os.system("copy action.py  ..\\cgi-bin\\ " if platform.system().lower() == "windows" else "cp action.py ../cgi-bin/")
        os.chdir('..')
        if platform.system().lower()!="windows":
            os.chdir("cgi-bin")
    ...
    if os.path.exists("index.html") is False:
        os.chdir("leakylan")
        os.system("copy index.html ..\\ " if platform.system().lower() == "windows" else "cp index.html ../ ")
        os.chdir("..")
