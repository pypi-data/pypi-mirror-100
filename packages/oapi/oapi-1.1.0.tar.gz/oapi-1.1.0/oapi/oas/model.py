...
sob.meta.writable(Reference).properties = [("ref", sob.properties.String(name="$ref"))]
...
sob.meta.writable(Example).properties = [
    ...
    (
        "external_value",
        sob.properties.String(name="externalValue", versions=("openapi>=3.0",)),
    ),
]
...
sob.meta.writable(MediaType).properties = [
    (
        "schema",
        sob.properties.Property(types=(Reference, Schema), versions=("openapi>=3.0",)),
    ),
...
sob.meta.writable(Items).properties = [
    ...
    ("format_", sob.properties.String(name="format", versions=("openapi<3.0",))),
    ("items", sob.properties.Property(types=(Items,), versions=("openapi<3.0",))),
    (
        "collection_format",
        sob.properties.Enumerated(
    ...
    (
        "exclusive_maximum",
        sob.properties.Boolean(name="exclusiveMaximum", versions=("openapi<3.0",)),
    ),
    ("minimum", sob.properties.Number(versions=("openapi<3.0",))),
    (
        "exclusive_minimum",
        sob.properties.Boolean(name="exclusiveMinimum", versions=("openapi<3.0",)),
    ),
    ("max_length", sob.properties.Integer(name="maxLength", versions=("openapi<3.0",))),
    ("min_length", sob.properties.Integer(name="minLength", versions=("openapi<3.0",))),
    ("pattern", sob.properties.String(versions=("openapi<3.0",))),
    ("max_items", sob.properties.Integer(name="maxItems", versions=("openapi<3.0",))),
    ("min_items", sob.properties.Integer(name="minItems", versions=("openapi<3.0",))),
    (
        "unique_items",
...
sob.meta.writable(Parameter).properties = [
    ...
    (
        "allow_reserved",
        sob.properties.Boolean(name="allowReserved", versions=("openapi>=3.0",)),
    ),
    ...
    (
        "content",
        sob.properties.Dictionary(value_types=(MediaType,), versions=("openapi>=3.0")),
    ),
    (
        "type_",
        sob.properties.Enumerated(
...
def _parameter_after_validate(o):
    ...
    if o.format_ in (
        ...
        if o.type_ == "integer" and (o.format_ not in ("int32", "int64", None)):
        ...
        elif o.type_ == "number" and (o.format_ not in ("float", "double", None)):
            qn = sob.utilities.qualified_name(type(o))
            raise sob.errors.ValidationError(
                '"%s" in not a valid value for `%s.format_` in this circumstance. '
                % (o.format_, qn)
...
sob.meta.writable(Link_).properties = [
    ...
    (
        "request_body",
        sob.properties.Property(name="requestBody", versions=("openapi>=3.0",)),
    ),
    ("description", sob.properties.String(versions=("openapi>=3.0",))),
...
sob.meta.writable(Responses).value_types = (
    sob.properties.Property(types=(Reference, Response), versions=("openapi>=3.0",)),
...
sob.meta.writable(Operation).properties = [
    ...
    (
        "external_docs",
        sob.properties.Property(types=(ExternalDocumentation,), name="externalDocs"),
    ),
    ...
    (
        "callbacks",
        sob.properties.Property(types=(Callbacks,), versions=("openapi>=3.0",)),
    ),
...
sob.meta.writable(Discriminator).properties = [
    ...
    (
        "mapping",
        sob.properties.Dictionary(value_types=(str,), versions=("openapi>=3.0",)),
    ),
]
...
sob.meta.writable(OAuthFlows).properties = [
    (
        "implicit",
        sob.properties.Property(types=(OAuthFlow,), versions=("openapi>=3.0",)),
    ),
    (
        "password",
        sob.properties.Property(types=(OAuthFlow,), versions=("openapi>=3.0",)),
    ...
    (
        "client_credentials",
        sob.properties.Property(
            types=(OAuthFlow,), name="clientCredentials", versions=("openapi>=3.0",),
        ),
    ),
    (
        "authorization_code",
        sob.properties.Property(
            types=(OAuthFlow,), name="authorizationCode", versions=("openapi>=3.0",)
        ),
    ),
]
...
sob.meta.writable(SecurityScheme).properties = [
    ...
    (
        ...
        sob.properties.Property(
            types=(
                sob.properties.Enumerated(
                    values=("query", "header", "cookie"), versions=("openapi>=3.0",)
                ),
                sob.properties.Enumerated(
    ...
    (
        ...
        sob.properties.Property(
            types=(
                ...
                sob.properties.Property(types=(str,), versions=("openapi<3.0",)),
            )
        ),
    ),
...
sob.meta.writable(Components).properties = [
    ...
    (
        "security_schemes",
        sob.properties.Property(types=(SecuritySchemes,), name="securitySchemes"),
    ),
...
sob.meta.writable(OpenAPI).properties = [
    ...
    (
        "components",
        sob.properties.Property(types=(Components,), versions=("openapi>=3.0",)),
    ),
    ("consumes", sob.properties.Array(item_types=(str,), versions=("openapi<3.0",))),
    ("swagger", sob.properties.String(versions=("openapi<3.0",), required=True)),
    (
        "definitions",
        sob.properties.Property(types=(Definitions,), versions=("openapi<3.0",)),
    ),
    (
        ...
        sob.properties.Property(
            types=(
                ...
                sob.properties.Dictionary(
                    value_types=(Reference, SecurityScheme), versions=("openapi>=3.0",)
                ),
            ),
    ...
    (
        "parameters",
        sob.properties.Dictionary(value_types=(Parameter,), versions=("openapi<3.0",)),
    ),
    (
        "responses",
        sob.properties.Dictionary(value_types=(Response,), versions=("openapi<3.0",)),
    ),
    (
        "security",
        sob.properties.Dictionary(
