import pandas as pd
from shioaji_order_executor.utils import ShioajiApi, logger, get_snapshot
...
class AccountAdmin(ShioajiApi):
    ...
    def get_positions_cost(self):
        ...
        stock_list = [i['code'] for i in positions]
        ...
        positions = positions.append({'code': 'cash', 'cost': available_balance, 'net_value': available_balance},
                                     ignore_index=True)
        return positions
