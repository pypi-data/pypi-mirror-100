...
class WOFEmoWorldModel(nn.Module):
    ...
    def __init__(self,
        ...
        super(WOFEmoWorldModel, self).__init__()
        ...
        self.linear_i2h = nn.Linear(state_size+estate_size, hidden_size)
    ...
    def forward(self, s, es, g, a, his):

        s = torch.cat([s, es, g], dim=1)
    ...
    def predict(self, s, es, g, a, his):

        with torch.no_grad():
            reward, term, action, emo_state = self.forward(s, es, g, a, his)
