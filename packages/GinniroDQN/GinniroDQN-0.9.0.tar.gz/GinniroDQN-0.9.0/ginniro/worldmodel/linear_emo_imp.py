...
class LinearEmoWorldModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.linear_h2er = nn.Linear(hidden_size, reward_size)
    ...
    def predict(self, s, a):
        ...
        return reward, ereward, term, action.argmax(1), emo_state