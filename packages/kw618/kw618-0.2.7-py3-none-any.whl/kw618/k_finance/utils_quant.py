...
class BinanceRestApi(myRequest):
    ...
    def __init__(self, api_type="spot", settings=lsh):
    ...
    def subscribe_trade_data(self):
        ...
        listenkey_dict = self.req_listen_key()
        listen_key = listenkey_dict.get("listenKey")
        url = f"{url}{listen_key}"
...
bra_spot = BinanceRestApi(api_type="spot", settings=lzc)
bra_futures = BinanceRestApi(api_type="futures", settings=lzc)
