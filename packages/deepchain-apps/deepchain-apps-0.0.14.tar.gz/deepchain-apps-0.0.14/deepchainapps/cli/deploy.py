...
def deploy(args):
    ...
    if args.checkpoints is not None:
        upload_checkpoint(args, pat, url, configuration["size_limit"])
...
def upload_code(
    ...
    """
    archive = shutil.make_archive(args.app_name, "zip", root_dir=app_dir)
...
def upload_checkpoint(
    args: argparse.ArgumentParser, pat: str, url: str, size_limit: int
):
    """
