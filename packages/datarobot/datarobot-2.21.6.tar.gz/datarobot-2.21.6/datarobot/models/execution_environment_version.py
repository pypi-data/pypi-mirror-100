...
from datarobot.enums import EXECUTION_ENVIRONMENT_VERSION_BUILD_STATUS, DEFAULT_MAX_WAIT
...
class ExecutionEnvironmentVersion(APIObject):
    ...
    def create(
        ...
        try:
            ...
            return cls._await_final_build_status(
                execution_environment_id, version_id, max_wait
            )
        finally:
    ...
    def _await_final_build_status(cls, execution_environment_id, version_id, max_wait):
        ...
        while True:
            ...
            if (
                ...
                in EXECUTION_ENVIRONMENT_VERSION_BUILD_STATUS.FINAL_STATUSES
            ):
                break
