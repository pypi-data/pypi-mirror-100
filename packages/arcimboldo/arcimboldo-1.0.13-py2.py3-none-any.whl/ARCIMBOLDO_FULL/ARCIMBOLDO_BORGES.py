...
def startARCIMBOLDO_BORGES(BorData, isShredder, input_bor, DicParameters={}, DicGridConn={}, cm=None, sym=None,
    ...
    frf_path = Config.get(job_type, "FRF_path")

    if frf_path is not '' and not os.path.exists(frf_path):
        print(colored("FATAL", "red"), "The FRF folder given in input: ", frf_path, " doesn't exist")
        sys.exit(1)
...
#updateAnomParamDic(hkl=None, mtz=None, current_directory=None, cell_dim=None, sg_number=1,otherAnomParamDic=None, st     artExpAnomDic=None)
    ...
    if frf_path is not '' and not os.path.exists(os.path.join(current_directory, "1_FRF_Library")):
