...
install_requires = \
['click>=7.1.2,<8.0.0', 'packaging', 'ply>=3.11,<4.0', 'six>=1.15.0,<2.0.0']

extras_require = \
{':python_version >= "2.7" and python_version < "2.8"': ['numpy>=1.9.3,<2.0.0'],
 ':python_version >= "3.6"': ['numpy>=1.19.4,<2.0.0'],
 'netcdf:python_version >= "2.7" and python_version < "2.8"': ['netCDF4<1.5.6'],
 'netcdf:python_version >= "3.6"': ['netCDF4>=1.4.3.2,<2.0.0.0']}
