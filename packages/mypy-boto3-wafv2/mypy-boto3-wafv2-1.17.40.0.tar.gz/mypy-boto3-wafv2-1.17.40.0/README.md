...
[boto3.WAFV2 1.17.40](https://boto3.amazonaws.com/v1/documentation/api/1.17.40/reference/services/wafv2.html#WAFV2) service
compatible with
...
def get_structure() -> AllowActionTypeDef:
    return {
      ...
    }
```
