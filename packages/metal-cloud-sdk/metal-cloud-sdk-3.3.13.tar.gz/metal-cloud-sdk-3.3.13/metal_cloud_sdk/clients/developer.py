...
class Developer(Client):
	...
	""" 985 functions available on endpoint. """
	...
	def volume_template_replicate_to_storages(self, nVolumeTemplateID, arrStoragePoolIDs):
	...
	def volume_template_update_storages(self, nOldVolumeTemplateID, nNewVolumeTemplateID, arrDstStoragePoolIDs):

		arrParams = [
			nOldVolumeTemplateID,
			nNewVolumeTemplateID,
