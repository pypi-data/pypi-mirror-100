...
from pydeezloader import Login
from pydeezloader.utils import what_kind
...
def download_link(
    ...
    if "track/" in link:
        ...
        func(link, output, quality, recursive_quality, recursive_download, not_gui)
...
parser = ArgumentParser(description="pyDeezloader-Loader")
...
parser.add_argument(
    "-q", "--quality", help="Select download quality between FLAC, 320, 256, 128"
)
...
if song and artist:
    downloa.download_name(
        artist, song, output, quality, recursive_quality, recursive_download, not_gui
    )
