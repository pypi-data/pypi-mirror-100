...
>>> model.add(dl.layers.Dense(n_out=100, n_in=50))
>>> model.add(dl.layers.Dense(n_out=3, activation=dl.activations.Softmax()))
>>> model.compile(loss=dl.objectives.SCCE(), optimizer=dl.optimizers.SGD(lr=0.005))
