...
class BatchNormal(Layer):
    ...
    epsilon ： small float > 0 
        Fuzz parameter. dl expects epsilon >= 1e-5.
    axis : integer
    ...
    beta_init : api.initializations.Initializer
        name of initialization function for shift parameter, or alternatively,
        dl function to use for weights initialization.
    gamma_init : api.initializations.Initializer
