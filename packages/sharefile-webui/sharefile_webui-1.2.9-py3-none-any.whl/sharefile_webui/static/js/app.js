class App {
	...
	_renderControls(){
		...
		let html = `<div class="control-item">`+
			`Copy link as: `+
				`<input id="copy-as-url" type="radio" name="radio-copy-as" value="url" checked> <label for="copy-as-url">URL</label>` +
				`<input id="copy-as-md" type="radio" name="radio-copy-as" value="md"><label for="copy-as-md">MarkDown</label>` +
				`<input id="copy-as-html" type="radio" name="radio-copy-as" value="html"><label for="copy-as-html">HTML</label>` +
			`</div>` +
