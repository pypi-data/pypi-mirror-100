...
def shape_measurements_3d(img_3d, threshold, spatial_resolution_xy,
                          spatial_resolution_z=1.0, dalpha=9,
    ...
    threshold : float
        ...
        pixels > threshold_3d_gv as object (foreground).
    ...
    spatial_resolution_z : float, optional
        Spatial resolution of `img_3d` in z-direction (height) in [mm/grayvalue], by default 1.
