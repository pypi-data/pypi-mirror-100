...
[boto3.KinesisVideoSignalingChannels 1.17.40](https://boto3.amazonaws.com/v1/documentation/api/1.17.40/reference/services/kinesis-video-signaling.html#KinesisVideoSignalingChannels) service
compatible with
