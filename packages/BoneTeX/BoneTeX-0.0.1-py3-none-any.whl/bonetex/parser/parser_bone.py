...
keywords = ["script", "fast-tex", "common-tex"]
...
def parse_block(name: str, flag: str, code_string: str):
    if flag == "template-tex":
        ...
        code_string = code_string.replace(".append", ".body_append")
