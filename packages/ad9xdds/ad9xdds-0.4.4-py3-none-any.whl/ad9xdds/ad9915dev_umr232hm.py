...
configuration file.
Check it in data directory of package or at the address:
...
class Ad9915DevUmr232Hm():
    ...
    def connect(self, url):
        ...
        self.write_w16(REGNAME2ADDR['CFR1'], [0x00, 0x01, 0x00, 0x0A])
        ## Default Default + Enable profile mode
        self.write_w16(REGNAME2ADDR['CFR2'], [0x00, 0x80, 0x09, 0x00])
    ...
    def dac_calibration(self):
        ...
        self.write_w16(REGNAME2ADDR['CFR4'], [0x01, 0x05, 0x21, 0x20])
        # Calibration 2/2: disable
        self.write_w16(REGNAME2ADDR['CFR4'], [0x00, 0x05, 0x21, 0x20])
    ...
    def set_ofreq(self, value, profile=None):
        ...
        # Send data to device
        self.write(REGNAME2ADDR[regname], ftw)
    ...
    def get_ofreq(self, profile=None):
        ...
        if profile is None:
            profile = 0
        regname = 'P{:d}Ftw'.format(profile)
        ftw = self.read(REGNAME2ADDR[regname])
        self._ofreq = self._actual_ofreq(self.get_sysfreq(), ftw, FTW_SIZE)
        return self._ofreq
    ...
    def get_output_state(self):
        ...
        """
        reg_value = self.read(REGNAME2ADDR['CFR1'])
        output_state_bit = 16
    ...
    def set_pll_state(self, state=False):
        ...
        :returns: None
        """
        reg_value = self.read(REGNAME2ADDR['CFR3'])
        pll_state_bit = 2
        if state is True:
            reg_value |= 1 << pll_state_bit
        else:
            reg_value &= ~(1 << pll_state_bit)
        self.write(REGNAME2ADDR['CFR3'], reg_value)
    ...
    def is_pll_locked(self):
        ...
        """
        reg_value = self.read(REGNAME2ADDR['USR0'])
        pll_lock_bit = 24
    ...
    def set_pll_divider_factor(self, value):
        ...
        cfr3 = self.read_w16(REGNAME2ADDR['CFR3'])
        cfr3[1] = value
        self.write_w16(REGNAME2ADDR['CFR3'], cfr3)
...
if __name__ == '__main__':
    ...
    DDS.connect(url='ftdi://ftdi:232h:4:1E:/1')
    ...
    DDS.set_ifreq(2.5e9)
    print("CFR2:", DDS.read_w16(REGNAME2ADDR['CFR2']))
    ...
    DDS.disconnect()
    print("Connected?", DDS.is_connected())
    try:
        print("Get phase")
        print("PHY:", DDS.get_phy())
