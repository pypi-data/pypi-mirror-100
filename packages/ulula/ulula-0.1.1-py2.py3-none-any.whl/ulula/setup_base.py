...
class Setup():
	...
	def trueSolution(self, sim, x, q_plot):
		...
		:func:`~ulula.simulation.Simulation.plot1D`. It must return a 2D array, with the solution in 
		...
		q_plot: array_like
			...
			the short strings given in the :data:`~ulula.simulation.fields` dictionary.
