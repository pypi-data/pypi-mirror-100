...
class ThemeCreatorTTK(tk.Tk):
    ...
    def update_theme(self, var, index, mode):
        ...
        settings = ThemeDefinition(name=theme_id, type=self.getvar('inputfg'), font=self.getvar('font'), colors=colors)
...
class EverythingBagel(ttk.Notebook):
    ...
    def create_widgets(self):
        ...
        # Widget images
        widget_frame = ttk.Labelframe(self.tab, padding=15, text='Widget images')
