...
from pyimporters_csv.csv import CSVKnowledgeParser, CSVOptions
from pyimporters_csv.excel import ExcelKnowledgeParser, ExcelOptions


def test_xls():
    source = Path('data/Digestion.xls')
    parser = ExcelKnowledgeParser()
    options = ExcelOptions(encoding="utf-8", identifier_col="ID", prefLabel_col="prefLabel_en", altLabel_cols="altLabel_en", multivalue_separator="|")
